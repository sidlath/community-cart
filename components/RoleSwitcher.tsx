...
export default function RoleSwitcher() {
  ...
  return (
    <div className="fixed bottom-5 left-1/2 -translate-x-1/2 z-[60] bg-ink text-cream rounded-full px-1.5 py-1.5 flex items-center gap-1 shadow-[0_16px_40px_-10px_rgba(42,24,16,0.5)]">
      <Link
        href="/"
